...
const FlashSection = () => {
  ...
  useGSAP(
    () => {
      const timelineFlash = gsap.timeline();


      timelineFlash.fromTo('.imgSloth',
          {
            // Початкові стилі
            position: 'absolute',
          },
  ...
  return (
    <>
      <div ref={container} className={classNames(styles.section, 'test3')}>
        <div className={styles.container}>
          <SpeechBubble
              ...
              text={
                <>
                  <p>
                    Embrace the slow fades, the diamond hand naps, and the
                    glorious absurdity that is $Snooz
                  </p>
                  <p>
                    And remember, with $Snooz, FOMO happens in slow-mo... so
                    you've got plenty of time to make a gloriously bad decision.
                  </p>
                </>
              }
          />
          ...
          <div className={classNames('startDiv')}></div>
        ...
        <Image
            ...
            priority
        />
        <ImageSloth className={"imgSloth"}/>
        <div className={classNames('endDiv')}></div>
        <InfoCard
      ...
      <Script
        ...
        onLoad={() => {
          console.log("ScrollSmoother loaded");
        }}
      />
    </>
  );
